...
//	CVariantBase( CUtlStringToken val ) :	m_flags( 0 ), m_type( FIELD_UTLSTRINGTOKEN )	{ m_utlStringToken = val.m_nHashCode; }
	...
	// dimhotepus: Uncomment Vector4D support.
...
inline void *CVariantBase<CValueAllocator>::Allocate( uintp nSize )
{
...
{
	intp nLen = ( m_type != FIELD_CSTRING ) ? 256 : V_strlen( m_pszString ) + 1;
