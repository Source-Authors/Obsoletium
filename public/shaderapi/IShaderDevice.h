...
{
	ShaderDisplayMode_t() { memset( this, 0, sizeof(*this) ); m_nVersion = SHADER_DISPLAY_MODE_VERSION; }
...
{
	ShaderDeviceInfo_t() { memset( this, 0, sizeof(*this) ); m_nVersion = SHADER_DEVICE_INFO_VERSION; m_DisplayMode.m_nVersion = SHADER_DISPLAY_MODE_VERSION; }
