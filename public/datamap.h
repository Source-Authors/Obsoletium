...
// dimhotepus: Add FTYPEDESC_KEY so key names are transferred and appiled.
#define DEFINE_AUTO_ARRAY_KEYFIELD(name,fieldtype,mapname)		_FIELD(name, fieldtype, SIZE_OF_ARRAY(((classNameTypedef *)0)->name), FTYPEDESC_KEY | FTYPEDESC_SAVE, mapname, 0 )
