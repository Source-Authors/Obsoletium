...
const char* ParseFile( const char* pFileBytes, OUT_Z_ARRAY char (&pTokenOut)[count], bool* pWasQuoted, characterset_t *pCharSet = nullptr, [[maybe_unused]] unsigned int nMaxTokenLen = (unsigned int)-1 )
{
