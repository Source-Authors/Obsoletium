...
public:
	...
	virtual void			DrawTranslucentSurfaces( IWorldRenderList *pList, int sortIndex, unsigned flags, bool bShadowDepth ) = 0;
	...
	virtual	bool			LeafContainsTranslucentSurfaces( IWorldRenderList *pList, int sortIndex, unsigned flags ) = 0;
