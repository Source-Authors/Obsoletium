...
public:
	...
	virtual [[nodiscard]] const vehicle_operatingparams_t &GetOperatingParams() = 0;
	virtual [[nodiscard]] const vehicleparams_t &GetVehicleParams() = 0;
	virtual [[nodiscard]] vehicleparams_t &GetVehicleParamsForChange() = 0;
	virtual [[nodiscard]] float UpdateBooster(float dt) = 0;
	virtual [[nodiscard]] int GetWheelCount(void) = 0;
	virtual [[nodiscard]] IPhysicsObject *GetWheel(int index) = 0;
	virtual [[nodiscard]] bool GetWheelContactPoint( int index, Vector *pContactPoint, int *pSurfaceProps ) = 0;
	...
	virtual [[nodiscard]] bool IsEngineDisabled( void ) = 0;
