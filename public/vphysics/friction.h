...
public:
	...
	virtual [[nodiscard]] bool IsValid() = 0;
	...
	virtual [[nodiscard]] float GetNormalForce() = 0;
	virtual [[nodiscard]] float GetEnergyAbsorbed() = 0;
	...
	virtual [[nodiscard]] float GetFrictionCoefficient() = 0;
};
