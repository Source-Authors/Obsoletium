...
public:
	...
	enum MemoryPoolGrowType_t
	{
		...
		GROW_SLOW=UTLMEMORYPOOL_GROW_SLOW
				...
				CUtlMemoryPool( intp blockSize, intp numElements, int growMode = UTLMEMORYPOOL_GROW_FAST, const char *pszAllocOwner = NULL, int nAlignment = 0 );
				~CUtlMemoryPool();
...
public:
	...
	CMemoryPoolMT(intp blockSize, intp numElements, int growMode = UTLMEMORYPOOL_GROW_FAST, const char *pszAllocOwner = NULL, int nAlignment = 0)
