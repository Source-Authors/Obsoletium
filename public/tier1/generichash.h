...
// dimhotepus: Moved here for better inlining.

constexpr inline unsigned g_nRandomValues[256] =
{
...
// int hash
//-----------------------------------------------------------------------------
[[nodiscard]] constexpr inline unsigned FASTCALL HashInt( const int n )
{
	unsigned odd   = g_nRandomValues[((n >> 8) & 0xff)];

	unsigned even  = g_nRandomValues[odd ^ (n >> 24)]; //-V519
...
[[nodiscard]] constexpr inline unsigned FASTCALL HashUint( const unsigned n )
{
	unsigned odd   = g_nRandomValues[((n >> 8) & 0xff)];
...
// String 
//-----------------------------------------------------------------------------
inline unsigned FASTCALL HashString( const char *pszKey )
{
...
// 4-byte hash
//-----------------------------------------------------------------------------
inline unsigned FASTCALL Hash4( const void *pKey )
{
...
// 8-byte hash
//-----------------------------------------------------------------------------
inline unsigned FASTCALL Hash8( const void *pKey )
{
	const auto *	p = (const uint32 *) pKey;
	unsigned		even,
					odd,
...
// 12-byte hash
//-----------------------------------------------------------------------------
inline unsigned FASTCALL Hash12( const void *pKey )
{
	const auto *	p = (const uint32 *) pKey;
	unsigned		even,
					odd,
...
// 16-byte hash
//-----------------------------------------------------------------------------
inline unsigned FASTCALL Hash16( const void *pKey )
{
	const auto *	p = (const uint32 *) pKey;
	unsigned		even,
					odd,
...
//-----------------------------------------------------------------------------
inline unsigned FASTCALL HashBlock( const void *pKey, unsigned size )
{
