...
public:
	...
	constexpr explicit CUtlKeyValuePair( const KInit &k ) : m_key( k ) {}
...
constexpr inline unsigned int Mix32HashFunctor::operator()( uint32 n ) const
{
...
constexpr inline unsigned int Mix64HashFunctor::operator()( uint64 s ) const 
{
