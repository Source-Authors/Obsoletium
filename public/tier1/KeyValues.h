...
public:
	...
	HKeySymbol GetNameSymbol() const { return m_iKeyName; }
	...
	Color GetColor( HKeySymbol keySymbol /* default value is all black */) const;
...
public:
	...
	static HKeySymbol GetSymbolForStringClassic( const char *name, bool bCreate = true );
	static const char *GetStringForSymbolClassic( HKeySymbol symbol );
	
	// Functions that use the growable string table
	static HKeySymbol GetSymbolForStringGrowable( const char *name, bool bCreate = true );
	static const char *GetStringForSymbolGrowable( HKeySymbol symbol );

	// Functions to get external access to whichever of the above functions we're going to call.
	static HKeySymbol CallGetSymbolForString( const char *name, bool bCreate = true ) { return s_pfGetSymbolForString( name, bCreate ); }
	static const char *CallGetStringForSymbol( HKeySymbol symbol ) { return s_pfGetStringForSymbol( symbol ); }
};
