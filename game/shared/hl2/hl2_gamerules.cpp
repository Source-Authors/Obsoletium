...
// dimhotepus: Reduce received ammo multiplier 0.6 -> 0.5.
ConVar	sk_ammo_qty_scale3 ( "sk_ammo_qty_scale3", "0.50", FCVAR_REPLICATED );
...
//		def.AddAmmoType("Extinguisher",				DMG_BURN,					TRACER_NONE,			0,	0, 100, 0, 0 );
		...
		def.AddAmmoType("CombineCannon",			DMG_BULLET,					TRACER_LINE,			"sk_npc_dmg_gunship_to_plr",	"sk_npc_dmg_gunship",			nullptr,				 1.5f * 750 * 12, 0 ); // hit like a 1.5kg weight at 750 ft/s
		...
		//=====================================================================
#ifdef HL2_EPISODIC
		def.AddAmmoType("StriderMinigun",		DMG_BULLET,					TRACER_LINE,			5, 5, 15, 1.0f * 750 * 12, AMMO_FORCE_DROP_IF_CARRIED ); // hit like a 1.0kg weight at 750 ft/s
#else
		def.AddAmmoType("StriderMinigun",		DMG_BULLET,					TRACER_LINE,			5, 15,15, 1.0f * 750 * 12, AMMO_FORCE_DROP_IF_CARRIED ); // hit like a 1.0kg weight at 750 ft/s
#endif//HL2_EPISODIC

		def.AddAmmoType("StriderMinigunDirect",	DMG_BULLET,					TRACER_LINE,			2, 2, 15, 1.0f * 750 * 12, AMMO_FORCE_DROP_IF_CARRIED ); // hit like a 1.0kg weight at 750 ft/s
