...
class CMapInstance : public CMapHelper
{
	public:
		...
		static bool			DeterminePath( const char *pszBaseFileName, const char *pszInstanceFileName, char *pszOutFileName, intp outFileName );
		template<intp outFileNameSize>
		static bool			DeterminePath( const char *pszBaseFileName, const char *pszInstanceFileName, char (&pszOutFileName)[outFileNameSize] )
		{
