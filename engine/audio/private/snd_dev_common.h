...
public:	
	...
	virtual int			PaintBegin( float, int, int ) { return 0; }
	...
	virtual void		UpdateListener( const Vector&, const Vector&, const Vector&, const Vector& ) {}
	...
	virtual void		ChannelReset( int, int, float ) {}
	virtual void		TransferSamples( int ) {}
