...
public:
	...
	virtual void        GetGameDir( OUT_Z_CAP(maxlength) char *szGetGameDir, int maxlength );
...
void CEngineTool::GetGameDir( OUT_Z_CAP(maxlength) char *szGetGameDir, int maxlength )
{
