...
CCreateMultiplayerGameServerPage::CCreateMultiplayerGameServerPage(
  ...
  SetControlString("ServerNameEdit", "Half-Life 2 dedicated server");
  V_strcpy_safe(m_szGameName, "Half-Life 2");
...
bool CCreateMultiplayerGameServerPage::LaunchOldDedicatedServer(
    [[maybe_unused]] KeyValues *pGameInfo) {
...
// Purpose: data accessor
//-----------------------------------------------------------------------------
const char *CCreateMultiplayerGameServerPage::GetRconPassword() const {
  return m_szPassword;
}
...
//-----------------------------------------------------------------------------
void CCreateMultiplayerGameServerPage::GetServer(serveritem_t &s) const {
  s = m_iServer;
