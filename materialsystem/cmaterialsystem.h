...
public:
	...
	intp									GetShaders( intp nFirstShader, intp nMaxCount, OUT_CAP_OPT(nMaxCount) IShader **ppShaderList ) const;
	intp									ShaderFlagCount() const;
	const char *							ShaderFlagName( intp nIndex ) const;
