...
#ifndef VPC_PROJECTGENERATOR_CODELITE_H_
#define VPC_PROJECTGENERATOR_CODELITE_H_

#include "baseprojectdatacollector.h"

class CProjectGenerator_CodeLite {
 public:
  void GenerateCodeLiteProject(CBaseProjectDataCollector *pCollector,
...
#endif  // VPC_PROJECTGENERATOR_CODELITE_H_
