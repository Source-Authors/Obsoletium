...
#ifndef VPC_INTERFACES_INTERFACES_H_
#define VPC_INTERFACES_INTERFACES_H_

// Interface creation function
using CreateInterfaceFn = void *(*)(const char *pName, int *pReturnCode);

// Macros to declare interfaces appropriate for various tiers
#if 1 || defined(TIER1_LIBRARY) || defined(TIER2_LIBRARY) || \
    defined(TIER3_LIBRARY) || defined(TIER4_LIBRARY) || defined(APPLICATION)
...
#if 1 || defined(TIER2_LIBRARY) || defined(TIER3_LIBRARY) || \
    defined(TIER4_LIBRARY) || defined(APPLICATION)
...
#if 1 || defined(TIER3_LIBRARY) || defined(TIER4_LIBRARY) || \
    defined(APPLICATION)
...
#define VPHYSICS2_RESOURCE_MGR_INTERFACE_VERSION \
...
DECLARE_TIER2_INTERFACE(IMaterialSystemHardwareConfig,
...
// NOTE: Appframework deals with connecting these bad boys. See
...
DECLARE_TIER3_INTERFACE(IDataCache, g_pDataCache);
...
#endif  // VPC_INTERFACES_INTERFACES_H_
