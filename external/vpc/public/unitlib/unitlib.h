...
#ifndef VPC_UNITLIB_UNITLIB_H_
#define VPC_UNITLIB_UNITLIB_H_
...
// functions, just not install them into the unit test library, or would make
// it so that you couldn't step through the unit test code).
//
...
// kinds of tests; the first is a single test case meant to run a piece
// of code and check its results match expected values using the Assert macros.
