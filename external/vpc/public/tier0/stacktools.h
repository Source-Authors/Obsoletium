...
#ifndef VPC_TIER0_STACKTOOLS_H_
#define VPC_TIER0_STACKTOOLS_H_
...
#define ENABLE_RUNTIME_STACK_TRANSLATION  // uncomment to enable runtime stack
                                          ...
                                          // on-demand loading of necessary
                                          // dll's and pdb's
#endif
...
using FN_GetCallStack = int (*)(void **pReturnAddressesOut, int iArrayCount,
                                int iSkipCount);
...
enum TranslateStackInfo_StyleFlags_t {
  ...
  TSISTYLEFLAG_LINE =
      (1 << 4),  // file line number					Sample:
                 // "(162)"
  TSISTYLEFLAG_LINEANDOFFSET =
      (1 << 5),  // file line + offset		Sample: "(162) + 4 bytes"
  TSISTYLEFLAG_LAST = TSISTYLEFLAG_LINEANDOFFSET,
  TSISTYLEFLAG_DEFAULT = (TSISTYLEFLAG_MODULENAME | TSISTYLEFLAG_SYMBOLNAME |
                          TSISTYLEFLAG_FULLPATH |
                       ...
                       // inlining pollution
{
 public:
  ...
  void *pStack[128];  // probably too big, possibly too small for some
                      // applications. Don't want to spend the time figuring out
                      // how to generalize this without templatizing pollution
                      // or mallocs
...
// string (not our data) 	all other negative values are the negative of how
// much dest buffer size is necessary.
