...
#ifndef VPC_TIER0_EVENTMODES_H_
#define VPC_TIER0_EVENTMODES_H_
...
class P4P4Event_TC_deliver_mode : public P4BaseEvent {
 public:
  ...
  void UseCounter5() { SetCounter(5); }
  void UseCounter6() { SetCounter(6); }
  void UseCounter7() { SetCounter(7); }
};
...

{
 public:
  ...
  void UseCounter0() { SetCounter(0); }
  void UseCounter1() { SetCounter(1); }
  void UseCounter2() { SetCounter(2); }
  void UseCounter3() { SetCounter(3); }
};
...

{
 public:
  ...
  void UseCounter8() { SetCounter(8); }
  void UseCounter9() { SetCounter(9); }
  void UseCounter10() { SetCounter(10); }
  void UseCounter11() { SetCounter(11); }
};
...

{
 public:
  ...
  void UseCounter12() { SetCounter(12); }
  void UseCounter13() { SetCounter(13); }

  void UseCounter14() { SetCounter(14); }
  void UseCounter15() { SetCounter(15); }

  void UseCounter16() { SetCounter(16); }
  void UseCounter17() { SetCounter(17); }
};
