...
#ifndef VPC_TIER0_P4PERFORMANCECOUNTERS_H_
#define VPC_TIER0_P4PERFORMANCECOUNTERS_H_
...
/*
 ...
 Architecture
    ...
    IA-32 Intel Architecture Software Developer's Manual Volume 2A: Instruction
 Set Reference, A-M
...
class P4BaseEvent {
 ...
 public:
  ...
  void SetOverflowEnables(P4ForceOverflow overflowEnable,
                          P4OverflowInterrupt overflowInterruptEnable) {
...
#endif  // VPC_TIER0_P4PERFORMANCECOUNTERS_H_
