...
#ifndef VPC_TIER0_MINIDUMP_H_
#define VPC_TIER0_MINIDUMP_H_
...
//
// ptchMinidumpFileNameBuffer if not-NULL should be a writable tchar buffer of
// length at least _MAX_PATH and on return will contain the name of the minidump
// file written. If ptchMinidumpFileNameBuffer is NULL the name of the minidump
// file written will not be available after the function returns.
//
