...
#ifndef VPC_TIER0_MEM_H_
#define VPC_TIER0_MEM_H_
...
// Only works with USE_MEM_DEBUG and memory allocation call stack tracking
// enabled.
MEM_INTERFACE int GetAllocationCallStack(void *mem, void **pCallStackOut,
                                         int iMaxEntriesOut);

#endif  // VPC_TIER0_MEM_H_
