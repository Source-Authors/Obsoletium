...
#ifndef VPC_TIER0_ETWPROF_H_
#define VPC_TIER0_ETWPROF_H_
...
ETWMarkPrintf(PRINTF_FORMAT_STRING const char *pMessage, ...) FMTFUNCTION(1, 2);
...
// Return the frame number recorded in the ETW trace -- useful for
// synchronization other profile information to the ETW trace.
...
inline void ETWMouseDown(int, int, int) {}
inline void ETWMouseUp(int, int, int) {}
inline void ETWKeyDown(int, int, const char *) {}

inline void ETWSendPacket(const char *, int, int, int) {}
inline void ETWThrottled() {}
inline void ETWReadPacket(const char *, int, int, int) {}
