...
#ifndef VPC_TIER0_ANALYSIS_ANNOTATIONS_H_
#define VPC_TIER0_ANALYSIS_ANNOTATIONS_H_
...
// For temporarily suppressing warnings -- the warnings are suppressed for the
// next source line.
...
#define ANALYZE_SUPPRESS3(wnum1, wnum2, wnum3) \
  __pragma(warning(suppress : wnum1 wnum2 wnum3))
#define ANALYZE_SUPPRESS4(wnum1, wnum2, wnum3, wnum4) \
  __pragma(warning(suppress : wnum1 wnum2 wnum3 wnum4))
...
#endif  // VPC_TIER0_ANALYSIS_ANNOTATIONS_H_
