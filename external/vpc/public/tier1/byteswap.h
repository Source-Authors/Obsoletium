...
#ifndef VPC_TIER1_BYTESWAP_H_
#define VPC_TIER1_BYTESWAP_H_
...
class CByteswap {
 public:
  ...
  static bool IsMachineBigEndian() {
    ...
    // if we are big endian, the first byte will be a 0, if little endian, it
    // will be a one.
