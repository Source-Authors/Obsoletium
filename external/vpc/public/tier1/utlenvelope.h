...
//
// Purpose: A class to wrap data for transport over a boundary like a thread or
// window.

#ifndef VPC_TIER1_UTLENVELOPE_H_
#define VPC_TIER1_UTLENVELOPE_H_
...
#endif  // VPC_TIER1_UTLENVELOPE_H_
