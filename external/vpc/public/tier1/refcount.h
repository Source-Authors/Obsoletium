...
#ifndef VPC_TIER1_REFCOUNT_H_
#define VPC_TIER1_REFCOUNT_H_

#include "tier0/threadtools.h"

// Purpose:	Implement a standard reference counted interface.  Use of this
// is optional insofar as all the concrete tools only require at compile time
// that the function signatures match.
struct IRefCounted {
...
#ifdef _DEBUG
template <class BASE_REFCOUNTED, int FINAL_REFS = 0,
          const char *pszName = (const char *)NULL>
