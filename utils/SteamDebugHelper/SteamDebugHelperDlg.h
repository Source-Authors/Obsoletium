...
#if !defined( \
    AFX_STEAMDEBUGHELPERDLG_H__E56B9648_8997_47D7_BEE1_CA0B572B380B__INCLUDED_)
...
class CSteamDebugHelperDlg : public CBaseDlg {
  // Construction
 public:
  explicit CSteamDebugHelperDlg(CWnd *pParent = nullptr);  // standard constructor
