...
#ifndef SE_UTILS_FILESYSTEMOPENDIALOG_FILESYSTEMOPENDLG_H_
#define SE_UTILS_FILESYSTEMOPENDIALOG_FILESYSTEMOPENDLG_H_
...
class CFileSystemOpenDlg final : public CBaseDlg
{
...
#endif // !SE_UTILS_FILESYSTEMOPENDIALOG_FILESYSTEMOPENDLG_H_
