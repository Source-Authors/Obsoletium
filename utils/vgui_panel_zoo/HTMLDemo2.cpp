...
HTMLDemo2::HTMLDemo2(Panel *parent, const char *name) : DemoPage(parent, name)
{
	...
	m_pHTML1->OpenURL("https://www.valvesoftware.com", NULL);
	// dimhotepus: Change dead link to smth meaningful.
	m_pHTML2->OpenURL("https://developer.valvesoftware.com", NULL);
