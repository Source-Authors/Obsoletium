...
#ifndef SE_UTILS_VWEIGHTEXP_VWEIGHTEXP_H_
#define SE_UTILS_VWEIGHTEXP_VWEIGHTEXP_H_
...
enum { MAX_NAME_CHARS = 70, UNDESIRABLE_NODE_MARKER = -7777 };
...
class VWeightExportClass : public SceneExport {
  friend BOOL CALLBACK ExportOptionsDlgProc(HWND hDlg, UINT message,
 ...
 public:
  ...
  // virtual int				DoExport		(const
  // TCHAR *name, ExpInterface *ei, Interface *i);
...
void GetUnifiedCoord(Point3 &p1, MaxVertWeight pweight[], MaxNode maxNode[],
                     int cMaxNode);

int GetBoneWeights(IPhyContextExport *mcExport, int iVertex,
                   MaxVertWeight *pweight);
...
#endif  // !SE_UTILS_VWEIGHTEXP_VWEIGHTEXP_H_
