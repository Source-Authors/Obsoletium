...
public:
	...
	virtual char const	*GetAreaMap( ptrdiff_t index );

	virtual ptrdiff_t			GetMapNumberCount();
	virtual char const	*GetMapNumber( ptrdiff_t index );

	virtual ptrdiff_t			GetReportTypeCount();
	virtual char const	*GetReportType( ptrdiff_t index );

	virtual char const *GetRepositoryURL( void ) { return NULL; }
	virtual char const *GetSubmissionURL( void ) { return NULL; }

	virtual ptrdiff_t			GetLevelCount(ptrdiff_t area) { return 0; }
	virtual char const	*GetLevel(ptrdiff_t area, ptrdiff_t index ) { return ""; }
...
char const *CBugReporter::GetPriority( ptrdiff_t index )
{
	return "<<Invalid>>";
}
...
char const *CBugReporter::GetArea( ptrdiff_t index )
{
	return "<<Invalid>>";
}
...
char const *CBugReporter::GetAreaMap( ptrdiff_t index )
{
	return "<<Invalid>>";
}
...
char const *CBugReporter::GetMapNumber( ptrdiff_t index )
{
	return "<<Invalid>>";
}
