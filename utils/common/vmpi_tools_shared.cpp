...
#define SE_CODE_2_ERROR_RECORD(name) {name, #name}

struct {
  DWORD code;
  const char *pReason;
} g_errorDescriptions[] = {
    SE_CODE_2_ERROR_RECORD(EXCEPTION_ACCESS_VIOLATION),
    SE_CODE_2_ERROR_RECORD(EXCEPTION_ARRAY_BOUNDS_EXCEEDED),
    SE_CODE_2_ERROR_RECORD(EXCEPTION_BREAKPOINT),
    SE_CODE_2_ERROR_RECORD(EXCEPTION_DATATYPE_MISALIGNMENT),
    SE_CODE_2_ERROR_RECORD(EXCEPTION_FLT_DENORMAL_OPERAND),
    SE_CODE_2_ERROR_RECORD(EXCEPTION_FLT_DIVIDE_BY_ZERO),
    SE_CODE_2_ERROR_RECORD(EXCEPTION_FLT_INEXACT_RESULT),
    SE_CODE_2_ERROR_RECORD(EXCEPTION_FLT_INVALID_OPERATION),
    SE_CODE_2_ERROR_RECORD(EXCEPTION_FLT_OVERFLOW),
    SE_CODE_2_ERROR_RECORD(EXCEPTION_FLT_STACK_CHECK),
    SE_CODE_2_ERROR_RECORD(EXCEPTION_FLT_UNDERFLOW),
    SE_CODE_2_ERROR_RECORD(EXCEPTION_ILLEGAL_INSTRUCTION),
    SE_CODE_2_ERROR_RECORD(EXCEPTION_IN_PAGE_ERROR),
    SE_CODE_2_ERROR_RECORD(EXCEPTION_INT_DIVIDE_BY_ZERO),
    SE_CODE_2_ERROR_RECORD(EXCEPTION_INT_OVERFLOW),
    SE_CODE_2_ERROR_RECORD(EXCEPTION_INVALID_DISPOSITION),
    SE_CODE_2_ERROR_RECORD(EXCEPTION_NONCONTINUABLE_EXCEPTION),
    SE_CODE_2_ERROR_RECORD(EXCEPTION_PRIV_INSTRUCTION),
    SE_CODE_2_ERROR_RECORD(EXCEPTION_SINGLE_STEP),
    SE_CODE_2_ERROR_RECORD(EXCEPTION_STACK_OVERFLOW),
    SE_CODE_2_ERROR_RECORD(EXCEPTION_ACCESS_VIOLATION),
};
