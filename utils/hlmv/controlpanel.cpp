...
void CBoneControlWindow::Init( )
{
	...
	// Bone selection list
	new mxLabel (this, quickUIScale( left + 3 ), quickUIScale( top + 4 ), quickUIScale( 30 ), quickUIScale( 18 ), "Bone");
	m_cBone = new mxChoice (this, quickUIScale( left ), quickUIScale( top + 20 ), quickUIScale( 260 ), quickUIScale( 22 ), IDC_BONE_BONELIST);
	m_cBone->add ("None");
	m_cBone->select (0);
	mxToolTip::add (m_cBone, "Select a bone to modify");

	// Show bone checkbox
	m_cBoneHighlight = new mxCheckBox (this, quickUIScale( left ), quickUIScale( top + 45 ), quickUIScale( 140 ), quickUIScale( 20 ), "Highlight Bone", IDC_BONE_HIGHLIGHT_BONE);
	mxToolTip::add (m_cBoneHighlight, "Toggle display of the bone being modified");

	// Bone surface property selection
	new mxLabel (this, quickUIScale( left + 3 ), quickUIScale( top + 68 ), quickUIScale( 100 ), quickUIScale( 18 ), "Bone Surface Prop");
	m_cSurfaceProp = new mxChoice( this, quickUIScale( left ), quickUIScale( top + 85 ), quickUIScale( 140 ), quickUIScale( 22 ), IDC_BONE_SURFACEPROP );
	...
	mxButton *btnApplyChild = new mxButton( this, quickUIScale( left ), quickUIScale( top + 115 ), quickUIScale( 140 ), quickUIScale( 20 ), "Apply to Children", IDC_BONE_APPLY_TO_CHILDREN );
	mxToolTip::add (btnApplyChild, "Apply the surface property to all child bones");

	// Use autogenerated hitboxes
	m_cAutoHitbox = new mxCheckBox (this, quickUIScale( left ), quickUIScale( top + 140 ), quickUIScale( 140 ), quickUIScale( 20 ), "Autogenerate Hitboxes", IDC_BONE_USE_AUTOGENERATED_HITBOXES);
	mxToolTip::add (m_cAutoHitbox, "When this is checked, studiomdl will automatically generate hitboxes");

	m_cShowDefaultPose = new mxCheckBox (this, quickUIScale( left ), quickUIScale( top + 160 ), quickUIScale( 140 ), quickUIScale( 20 ), "Show Default Pose", IDC_BONE_SHOW_DEFAULT_POSE);
	mxToolTip::add (m_cShowDefaultPose, "Toggles display of the default physics pose");

	left = 160;

	new mxLabel( this, quickUIScale( left + 3 ), quickUIScale( top + 50 ), quickUIScale( 80 ), quickUIScale( 18 ), "Hitbox Set" );
	m_cHitboxSet = new mxChoice (this, quickUIScale( left ), quickUIScale( top + 66 ), quickUIScale( 100 ), quickUIScale( 22 ), IDC_BONE_HITBOXSET);
	m_cHitboxSet->add ("unnamed");
	m_cHitboxSet->select (0);
	mxToolTip::add (m_cHitboxSet, "Change hitbox set");

	m_eHitboxSetName = new mxLineEdit(this, quickUIScale( left ), quickUIScale( top + 96 ), quickUIScale( 100 ), quickUIScale( 18 ), "", IDC_BONE_HITBOXSETNAME_EDIT);
	mxToolTip::add (m_eHitboxSetName, "Type in a name and hit the set button");

	m_bHitboxSetUpdateName = new mxButton( this, quickUIScale( left ), quickUIScale( top + 116 ), quickUIScale( 100 ), quickUIScale( 16 ), "Set Name", IDC_BONE_HITBOXSETNAME );
	mxToolTip::add (m_bHitboxSetUpdateName, "Press to set hitbox set name from above text field");

	m_bAddHitboxSet = new mxButton( this, quickUIScale( left ), quickUIScale( top + 140 ), quickUIScale( 100 ), quickUIScale( 20 ), "Add set", IDC_BONE_HITBOXADDSET );
	mxToolTip::add (m_bAddHitboxSet, "Add a hitbox set");
	m_bDeleteHitboxSet= new mxButton( this, quickUIScale( left ), quickUIScale( top + 162 ), quickUIScale( 100 ), quickUIScale( 20 ), "Delete set", IDC_BONE_HITBOXDELETESET );
	mxToolTip::add (m_bDeleteHitboxSet, "Remove a hitbox set");

	left += 120;

	// Hitbox selection list
	new mxLabel (this, quickUIScale( left + 3 ), quickUIScale( top + 4 ), quickUIScale( 30 ), quickUIScale( 18 ), "Hitbox");
	m_cHitbox = new mxChoice (this, quickUIScale( left ), quickUIScale( top + 20 ), quickUIScale( 100 ), quickUIScale( 22 ), IDC_BONE_HITBOXLIST);
	m_cHitbox->add ("None");
	m_cHitbox->select (0);
	mxToolTip::add (m_cHitbox, "Select a hitbox to modify");

	// Show hitbox checkbox
	m_cHitboxHighlight = new mxCheckBox (this, quickUIScale( left + 3 ), quickUIScale( top + 45 ), quickUIScale( 100 ), quickUIScale( 20 ), "Highlight Hitbox", IDC_BONE_HIGHLIGHT_HITBOX);
	mxToolTip::add (m_cHitboxHighlight, "Toggle display of the hitbox being modified");

	// Hitbox group
	new mxLabel (this, quickUIScale( left + 3 ), quickUIScale( top + 80 ), quickUIScale( 80 ), quickUIScale( 18 ), "Hitbox Group");
	m_eHitboxGroup = new mxLineEdit(this, quickUIScale( left + 80 ), quickUIScale( top + 75 ), quickUIScale( 50 ), quickUIScale( 22 ), "", IDC_BONE_HITBOX_GROUP);
	mxToolTip::add (m_eHitboxGroup, "The group of the current hitbox");

	// Hitbox name
	new mxLabel (this, quickUIScale( left + 133 ), quickUIScale( top + 80 ), quickUIScale( 80 ), quickUIScale( 18 ), "Hitbox Name");
	m_eHitboxName = new mxLineEdit(this, quickUIScale( left + 133+80 ), quickUIScale( top + 75 ), quickUIScale( 50 ), quickUIScale( 22 ), "", IDC_BONE_HITBOX_NAME);
	m_eHitboxName->setEnabled(false);
	mxToolTip::add (m_eHitboxName, "The name of the current hitbox");

	// Hitbox origin
	new mxLabel (this, quickUIScale( left + 3 ),   quickUIScale( top + 110 ), quickUIScale( 80 ), quickUIScale( 18 ), "Hitbox Origin");
	new mxLabel (this, quickUIScale( left + 133 ), quickUIScale( top + 110 ), quickUIScale( 10 ), quickUIScale( 18 ), "X");
	new mxLabel (this, quickUIScale( left + 198 ), quickUIScale( top + 110 ), quickUIScale( 10 ), quickUIScale( 18 ), "Y");
	new mxLabel (this, quickUIScale( left + 263 ), quickUIScale( top + 110 ), quickUIScale( 10 ), quickUIScale( 18 ), "Z");
	m_eOriginX = new mxLineEdit(this, quickUIScale( left + 80 ), quickUIScale( top + 105 ), quickUIScale( 50 ), quickUIScale( 22 ), "", IDC_BONE_HITBOX_ORIGINX);
	m_eOriginY = new mxLineEdit(this, quickUIScale( left + 145 ), quickUIScale( top + 105 ), quickUIScale( 50 ), quickUIScale( 22 ), "", IDC_BONE_HITBOX_ORIGINY);
	m_eOriginZ = new mxLineEdit(this, quickUIScale( left + 210 ), quickUIScale( top + 105 ), quickUIScale( 50 ), quickUIScale( 22 ), "", IDC_BONE_HITBOX_ORIGINZ);

	// Hitbox size
	new mxLabel (this, quickUIScale( left + 3 ),   quickUIScale( top + 140 ), quickUIScale( 80 ), quickUIScale( 18 ), "Hitbox Size");
	new mxLabel (this, quickUIScale( left + 133 ), quickUIScale( top + 140 ), quickUIScale( 10 ), quickUIScale( 18 ), "X");
	new mxLabel (this, quickUIScale( left + 198 ), quickUIScale( top + 140 ), quickUIScale( 10 ), quickUIScale( 18 ), "Y");
	new mxLabel (this, quickUIScale( left + 263 ), quickUIScale( top + 140 ), quickUIScale( 10 ), quickUIScale( 18 ), "Z");
	m_eSizeX = new mxLineEdit(this, quickUIScale( left + 80 ), quickUIScale( top + 135 ), quickUIScale( 50 ), quickUIScale( 22 ), "", IDC_BONE_HITBOX_SIZEX);
	m_eSizeY = new mxLineEdit(this, quickUIScale( left + 145 ), quickUIScale( top + 135 ), quickUIScale( 50 ), quickUIScale( 22 ), "", IDC_BONE_HITBOX_SIZEY);
	m_eSizeZ = new mxLineEdit(this, quickUIScale( left + 210 ), quickUIScale( top + 135 ), quickUIScale( 50 ), quickUIScale( 22 ), "", IDC_BONE_HITBOX_SIZEZ);

	// Update hitboxes here
	m_bUpdateHitbox = new mxButton( this, quickUIScale( left ), quickUIScale( top + 163 ), quickUIScale( 100 ), quickUIScale( 20 ), "Update Hitbox", IDC_BONE_UPDATE_HITBOX );
	mxToolTip::add (m_bUpdateHitbox, "Apply hitbox group, origin, and size to the hitbox");

	left += 160;

	// Generate a QC file
	mxButton* btnGenerateQC = new mxButton (this, quickUIScale( left ), quickUIScale( top + 10 ), quickUIScale( 100 ), quickUIScale( 20 ), "Generate QC", IDC_BONE_GENERATEQC );
	mxToolTip::add (btnGenerateQC, "Copy a .qc file snippet to the clipboard");

	// Add, remove hitboxes here
	m_bAddHitbox = new mxButton( this, quickUIScale( left ), quickUIScale( top + 30 ), quickUIScale( 100 ), quickUIScale( 20 ), "Add Hitbox", IDC_BONE_ADD_HITBOX );
	m_bDeleteHitbox = new mxButton( this, quickUIScale( left ), quickUIScale( top + 50 ), quickUIScale( 100 ), quickUIScale( 20 ), "Delete Hitbox", IDC_BONE_DELETE_HITBOX );
...
: mxWindow( parent, 0, 0, 0, 0, "Control Panel", mxWindow::Normal )
{
	...
	// frame slider
	new mxLabel( this, quickUIScale( 5 ), quickUIScale( 220 ), quickUIScale( 50 ), quickUIScale( 18 ), "Frame" );
	slForceFrame = new mxSlider( this, quickUIScale( 55 ), quickUIScale( 220 ), quickUIScale( 450 ), quickUIScale( 18 ), IDC_FORCEFRAME );
	slForceFrame->setRange( 0, 1.0 );
	slForceFrame->setValue( 0.0 );
	slForceFrame->setSteps( 1, 1 );
	mxToolTip::add( slForceFrame, "Force To Frame" );
	lForcedFrame = new mxLabel( this, quickUIScale( 505 ), quickUIScale( 220 ), quickUIScale( 30 ), quickUIScale( 18 ), "0" );

	// create tabcontrol with subdialog windows
	tab = new mxTab( this, 0, quickUIScale( 20 ), 0, 0, IDC_TAB );
#ifdef WIN32
...
void ControlPanel::SetupRenderWindow( mxTab* pTab )
{
	...
	cRenderMode = new mxChoice (wRender, quickUIScale( 5 ), quickUIScale( 2 ), quickUIScale( 100 ), quickUIScale( 22 ), IDC_RENDERMODE);
...
//	cRenderMode->add ("Flatshaded");
	...
	cbGround = new mxCheckBox (wRender, quickUIScale( 125 ), quickUIScale( 5 ), quickUIScale( 150 ), quickUIScale( 20 ), "Ground (Ctrl-G)", IDC_GROUND);
	cbGround->setEnabled( true );
	cbMovement = new mxCheckBox (wRender, quickUIScale( 125 ), quickUIScale( 25 ), quickUIScale( 150 ), quickUIScale( 20 ), "Movement (Ctrl-M)", IDC_MOVEMENT);
	cbMovement->setEnabled( true );
	cbBackground = new mxCheckBox (wRender, quickUIScale( 125 ), quickUIScale( 45 ), quickUIScale( 150 ), quickUIScale( 20 ), "Background (Ctrl-B)", IDC_BACKGROUND);
	cbBackground->setEnabled( true );
	cbHitBoxes = new mxCheckBox (wRender, quickUIScale( 125 ), quickUIScale( 65 ), quickUIScale( 150 ), quickUIScale( 20 ), "Hit Boxes (Ctrl-H)", IDC_HITBOXES);
	cbSequenceBoxes = new mxCheckBox (wRender, quickUIScale( 125 ), quickUIScale( 85 ), quickUIScale( 150 ), quickUIScale( 20 ), "Seq. Boxes", IDC_SEQUENCEBOXES);
	cbShadow = new mxCheckBox (wRender, quickUIScale( 125 ), quickUIScale( 105 ), quickUIScale( 150 ), quickUIScale( 20 ), "Shadow (Ctrl-S)", IDC_SHADOW);
	cbSoftwareSkin = new mxCheckBox (wRender, quickUIScale( 125 ), quickUIScale( 125 ), quickUIScale( 150 ), quickUIScale( 20 ), "Software Skin", IDC_SOFTWARESKIN);
	cbSoftwareSkin->setEnabled( true );
	cbOverbright2 = new mxCheckBox (wRender, quickUIScale( 125 ), quickUIScale( 145 ), quickUIScale( 150 ), quickUIScale( 20 ), "Enable Overbrightening", IDC_OVERBRIGHT2);
	cbOverbright2->setEnabled( true );
	cbOverbright2->setChecked( true );
	setOverbright( true );

	cbAttachments = new mxCheckBox (wRender, quickUIScale( 5 ), quickUIScale( 45 ), quickUIScale( 120 ), quickUIScale( 20 ), "Attachments (Ctrl-A)", IDC_ATTACHMENTS);
	cbAttachments->setEnabled( true );

	cbBones = new mxCheckBox (wRender, quickUIScale( 5 ), quickUIScale( 65 ), quickUIScale( 120 ), quickUIScale( 20 ), "Bones (Ctrl-O)", IDC_BONES);

	cbNormals = new mxCheckBox (wRender, quickUIScale( 5 ), quickUIScale( 85 ), quickUIScale( 120 ), quickUIScale( 20 ), "Normals (Ctrl-N)", IDC_NORMALS);
	cbNormals->setEnabled( true );
	cbNormals->setChecked( false );

	cbTangentFrame = new mxCheckBox( wRender, quickUIScale( 5 ), quickUIScale( 105 ), quickUIScale( 120 ), quickUIScale( 20 ), "Tangents (Ctrl-T)", IDC_TANGENTFRAME );
	cbTangentFrame->setEnabled( true );
	cbTangentFrame->setChecked( false );

	cbOverlayWireframe = new mxCheckBox (wRender, quickUIScale( 5 ), quickUIScale( 125 ), quickUIScale( 120 ), quickUIScale( 20 ), "Wireframe (Ctrl-W)", IDC_OVERLAY_WIREFRAME);
	cbOverlayWireframe->setEnabled( true );
	cbOverlayWireframe->setChecked( false );

//	cbParallaxMap = new mxCheckBox (wRender, quickUIScale( 5 ), quickUIScale( 125 ), quickUIScale( 100 ), quickUIScale( 20 ), "Parallax Mapping", IDC_PARALLAXMAP);
//	cbParallaxMap->setEnabled( true );
//	cbParallaxMap->setChecked( true );

	cbSpecular = new mxCheckBox (wRender, quickUIScale( 5 ), quickUIScale( 145 ), quickUIScale( 120 ), quickUIScale( 20 ), "Specular", IDC_SPECULAR);
	cbSpecular->setEnabled( true );
	cbSpecular->setChecked( true );

	cbNormalMap = new mxCheckBox (wRender, quickUIScale( 5 ), quickUIScale( 25 ), quickUIScale( 100 ), quickUIScale( 20 ), "Normal Mapping", IDC_NORMALMAP);
	cbNormalMap->setEnabled( true );
	cbNormalMap->setChecked( true );

	cbRunIK = new mxCheckBox (wRender, quickUIScale( 275 ), quickUIScale( 65 ), quickUIScale( 150 ), quickUIScale( 20 ), "Enable IK", IDC_RUNIK);
	cbEnableHead = new mxCheckBox (wRender, quickUIScale( 275 ), quickUIScale( 85 ), quickUIScale( 150 ), quickUIScale( 20 ), "Head Turn", IDC_HEADTURN);

	cbIllumPosition = new mxCheckBox (wRender, quickUIScale( 275 ), quickUIScale( 105 ), quickUIScale( 150 ), quickUIScale( 20 ), "Illum. Position", IDC_ILLUMPOSITION);

	cbPlaySounds = new mxCheckBox (wRender, quickUIScale( 275 ), quickUIScale( 125 ), quickUIScale( 150 ), quickUIScale( 20 ), "Play Sounds", IDC_PLAYSOUNDS);

	cbShowOriginAxis = new mxCheckBox (wRender, quickUIScale( 275 ), quickUIScale( 145 ), quickUIScale( 150 ), quickUIScale( 20 ), "Show Origin Axis", IDC_SHOWORIGINAXIS);

	new mxLabel (wRender, quickUIScale( 275 ), quickUIScale( 170 ), quickUIScale( 45 ), quickUIScale( 18 ), "Axis Len:");
	leOriginAxisLength = new mxSlider(wRender, quickUIScale( 320 ), quickUIScale( 165 ), quickUIScale( 105 ), quickUIScale( 22 ), IDC_ORIGINAXISLENGTH);
	leOriginAxisLength->setRange( 1, 100 );
	leOriginAxisLength->setValue( 10 );

	new mxCheckBox (wRender, quickUIScale( 275 ), quickUIScale( 5 ), quickUIScale( 150 ), quickUIScale( 20 ), "Physics Model", IDC_PHYSICSMODEL);
	cHighlightBone = new mxChoice (wRender, quickUIScale( 275 ), quickUIScale( 25 ), quickUIScale( 150 ), quickUIScale( 22 ), IDC_PHYSICSHIGHLIGHT);
	cHighlightBone->add ("None");
	cHighlightBone->select (0);
	mxToolTip::add (cHighlightBone, "Select Physics Bone to highlight");

	new mxLabel (wRender, quickUIScale( 5 ), quickUIScale( 170 ), quickUIScale( 30 ), quickUIScale( 18 ), "FOV:");
	leFOV = new mxLineEdit(wRender, quickUIScale( 35 ), quickUIScale( 165 ), quickUIScale( 30 ), quickUIScale( 22 ), "65", IDC_RENDER_FOV);
}
...
void ControlPanel::SetupSequenceWindow( mxTab* pTab )
{
	...
	{
		cSequence[i] = new mxChoice (wSequence, quickUIScale( 5 ), quickUIScale( 5 + i * 22 ), quickUIScale( 200 ), quickUIScale( 22 ), IDC_SEQUENCE0+i);	
		mxToolTip::add (cSequence[i], "Select Sequence");
		slSequence[i] = new mxSlider (wSequence, quickUIScale( 208 ), quickUIScale( 5 + i * 22 ), quickUIScale( 80 ), quickUIScale( 18 ), IDC_SEQUENCESCALE0+i);
		slSequence[i]->setRange (0, 1.0, 100);
		slSequence[i]->setValue (0.0);

		rbFrameSelection[i] = new mxRadioButton (wSequence, quickUIScale( 300 ), quickUIScale( 5 + i * 22 ), quickUIScale( 35 ), quickUIScale( 22 ), "", IDC_FRAMESELECTION0+i, i == 0);
	}
	slSequence[0]->setVisible( false );

	laGroundSpeed = new mxLabel( wSequence, quickUIScale( 208 ), quickUIScale( 5 ), quickUIScale( 80 ), quickUIScale( 18 ), "" );
	...
	for ( int i = 0; i < NUM_POSEPARAMETERS; i++ )
	{
		...
		cPoseParameter[i] = new mxChoice (wSequence, quickUIScale( 520 ), quickUIScale( y ), quickUIScale( 96 ), quickUIScale( 22 ), IDC_POSEPARAMETER+i);	
		cPoseParameter[i]->setVisible( false );

		slPoseParameter[i] = new mxSlider (wSequence, quickUIScale( x ), quickUIScale( y ), quickUIScale( 140 ), quickUIScale( 16 ), IDC_POSEPARAMETER_SCALE+i);
		slPoseParameter[i]->setRange (0.0, 1.0, 1000);
		mxToolTip::add (slPoseParameter[i], "Parameter");
		slPoseParameter[i]->setVisible( false );

		lePoseParameter[i] = new mxLineEdit ( wSequence, quickUIScale( x + 146 ), quickUIScale( y ), quickUIScale( 40 ), quickUIScale( 16 ), "X", IDC_POSEPARAMETER_VALUE+i );
		lePoseParameter[i]->setVisible( false );
	}

	slSpeedScale = new mxSlider (wSequence, quickUIScale( 5 ), quickUIScale( 115 ), quickUIScale( 200 ), quickUIScale( 18 ), IDC_SPEEDSCALE);
	slSpeedScale->setRange (0, 1.0, 100);
	slSpeedScale->setValue (1.0);
	mxToolTip::add (slSpeedScale, "Speed Scale");
	laFPS = new mxLabel (wSequence, quickUIScale( 208 ), quickUIScale( 115 ), quickUIScale( 128 ), quickUIScale( 22 ), "" );

	new mxCheckBox (wSequence, quickUIScale( 5 ), quickUIScale( 142 ), quickUIScale( 150 ), quickUIScale( 20 ), "Blend Sequence Changes", IDC_BLENDSEQUENCECHANGES);
	new mxButton( wSequence, quickUIScale( 155 ), quickUIScale( 142 ), quickUIScale( 80 ), quickUIScale( 20 ), "Blend Now", IDC_BLENDNOW );
	laBlendAmount = new mxLabel( wSequence, quickUIScale( 240 ), quickUIScale( 142 ), quickUIScale( 60 ), quickUIScale( 20 ), "" );

	slBlendTime = new mxSlider( wSequence, quickUIScale( 308 ), quickUIScale( 142 ), quickUIScale( 200 ), quickUIScale( 18 ), IDC_BLENDTIME );
	slBlendTime->setRange( 0, 1.0, 100 );
	slBlendTime->setValue( DEFAULT_BLEND_TIME );
	laBlendTime = new mxLabel( wSequence, quickUIScale( 540 ), quickUIScale( 142 ), quickUIScale( 80 ), quickUIScale( 22 ), "" );

	new mxLabel (wSequence, quickUIScale( 5 ), quickUIScale( 170 ), quickUIScale( 90 ), quickUIScale( 18 ), "Activity modifiers:");
	cActivityModifiers = new mxChoice (wSequence, quickUIScale( 105 ), quickUIScale( 166 ), quickUIScale( 350 ), quickUIScale( 22 ), IDC_ACTIVITY_MODIFIERS);

	new mxCheckBox (wSequence, quickUIScale( 460 ), quickUIScale( 166 ), quickUIScale( 350 ), quickUIScale( 22 ), "Animate weapons", IDC_ANIMATEWEAPONS);
}
...
void ControlPanel::SetupBodyWindow( mxTab* pTab )
{
	...
	cBodypart = new mxChoice (wBody, quickUIScale( 5 ), quickUIScale( 5 ), quickUIScale( 100 ), quickUIScale( 22 ), IDC_BODYPART);
	mxToolTip::add (cBodypart, "Choose a bodypart");
	cSubmodel = new mxChoice (wBody, quickUIScale( 110 ), quickUIScale( 5 ), quickUIScale( 100 ), quickUIScale( 22 ), IDC_SUBMODEL);
	mxToolTip::add (cSubmodel, "Choose a submodel of current bodypart");
	cController = new mxChoice (wBody, quickUIScale( 5 ), quickUIScale( 30 ), quickUIScale( 100 ), quickUIScale( 22 ), IDC_CONTROLLER);	
	mxToolTip::add (cController, "Choose a bone controller");
	slController = new mxSlider (wBody, quickUIScale( 105 ), quickUIScale( 32 ), quickUIScale( 100 ), quickUIScale( 18 ), IDC_CONTROLLERVALUE);
	slController->setRange (0, 255);
	mxToolTip::add (slController, "Change current bone controller value");
	lModelInfo1 = new mxLabel (wBody, quickUIScale( 220 ), quickUIScale( 5 ), quickUIScale( 120 ), quickUIScale( 80 ), "No Model.");
	lModelInfo2 = new mxLabel (wBody, quickUIScale( 340 ), quickUIScale( 5 ), quickUIScale( 120 ), quickUIScale( 130 ), "");
	cSkin = new mxChoice (wBody, quickUIScale( 5 ), quickUIScale( 55 ), quickUIScale( 100 ), quickUIScale( 22 ), IDC_SKINS);
	mxToolTip::add (cSkin, "Choose a skin family");
	new mxLabel (wBody, quickUIScale( 5 ), quickUIScale( 170 ), quickUIScale( 90 ), quickUIScale( 18 ), "Materials used:");
	cMaterials = new mxChoice (wBody, quickUIScale( 105 ), quickUIScale( 166 ), quickUIScale( 350 ), quickUIScale( 22 ), IDC_MATERIALS);	
	mxToolTip::add (cMaterials, "Select material for UV Chart view");

	lModelInfo3 = new mxLabel (wBody, quickUIScale( 220 ), quickUIScale( 100 ), quickUIScale( 220 ), quickUIScale( 18 ), "");
	lModelInfo4 = new mxLabel (wBody, quickUIScale( 220 ), quickUIScale( 118 ), quickUIScale( 260 ), quickUIScale( 18 ), "");
	lModelInfo5 = new mxLabel (wBody, quickUIScale( 220 ), quickUIScale( 136 ), quickUIScale( 120 ), quickUIScale( 18 ), "");
	setTransparent( false );

	cbAutoLOD = new mxCheckBox (wBody, quickUIScale( 5 ), quickUIScale( 80 ), quickUIScale( 100 ), quickUIScale( 20 ), "Auto LOD", IDC_AUTOLOD);
	cbAutoLOD->setEnabled( true );
	cLODChoice = new mxChoice( wBody, quickUIScale( 5 ), quickUIScale( 101 ), quickUIScale( 100 ), quickUIScale( 22 ), IDC_LODCHOICE);
	mxToolTip::add (cLODChoice, "Select model LOD to render");
	new mxLabel (wBody, quickUIScale( 5 ), quickUIScale( 126 ), quickUIScale( 60 ), quickUIScale( 18 ), "LOD Switch:");
	leLODSwitch = new mxLineEdit(wBody, quickUIScale( 70 ), quickUIScale( 126 ), quickUIScale( 35 ), quickUIScale( 22 ), "", IDC_LODSWITCH);
	new mxLabel (wBody, quickUIScale( 5 ), quickUIScale( 151 ), quickUIScale( 60 ), quickUIScale( 18 ), "LOD Metric:" ); 
	lLODMetric = new mxLabel( wBody, quickUIScale( 70 ), quickUIScale( 151 ), quickUIScale( 35 ), quickUIScale( 22 ), "" );

	new mxLabel( wBody, quickUIScale( 505 ), quickUIScale( 5 ), quickUIScale( 100 ), quickUIScale( 18 ), "VMTs Loaded:" );
	cMessageList = new mxListBox( wBody, quickUIScale( 500 ), quickUIScale( 25 ), quickUIScale( 540 ), quickUIScale( 160 ), IDC_MESSAGES );
	cMessageList->add ("None");
	cMessageList->select (1);
	mxToolTip::add (cMessageList, "Materials (VMT files) this model has loaded");

	new mxLabel( wBody, quickUIScale( 785 ), quickUIScale( 5 ), quickUIScale( 100 ), quickUIScale( 18 ), "Shader:" );
	cShaderUsed = new mxListBox( wBody, quickUIScale( 830 ), quickUIScale( 3 ), quickUIScale( 210 ), quickUIScale( 28 ), IDC_SHADERS );
...
void ControlPanel::SetupFlexWindow( mxTab* pTab )
{
	...
	{
		int w = (i / FLEX_ROWS_OF_SLIDERS) * quickUIScale( FLEX_SLIDER_WIDTH + FLEX_DROPDOWN_WIDTH + 4 ) + quickUIScale( 5 );
		int h = (i % FLEX_ROWS_OF_SLIDERS) * quickUIScale( 20 ) + quickUIScale( 5 );

		cFlex[i] = new mxChoice (wFlex, w, h, quickUIScale( FLEX_DROPDOWN_WIDTH ), quickUIScale( 22 ), IDC_FLEX + i);
		mxToolTip::add (cFlex[i], "Select Flex");
		slFlexScale[i] = new mxSlider (wFlex, w + quickUIScale( FLEX_DROPDOWN_WIDTH ), h, quickUIScale( FLEX_SLIDER_WIDTH ), quickUIScale( 18 ), IDC_FLEXSCALE + i);
	...
	{
		int h = FLEX_ROWS_OF_SLIDERS * quickUIScale( 20 ) + quickUIScale( 5 );
		new mxButton( wFlex, quickUIScale( 5 ), h + quickUIScale( 1 ), quickUIScale( FLEX_DROPDOWN_WIDTH - 2 ), quickUIScale( 18 ), "Reset", IDC_FLEXDEFAULTS );

		int w = quickUIScale( ( FLEX_DROPDOWN_WIDTH + 4 ) + 5 );
		new mxButton( wFlex, w, h + quickUIScale( 1 ), quickUIScale( FLEX_DROPDOWN_WIDTH - 2 ), quickUIScale( 18 ), "Random", IDC_FLEXRANDOM );

		w += quickUIScale( ( FLEX_DROPDOWN_WIDTH + 4 ) + 5 );
		new mxButton( wFlex, w, h + quickUIScale( 1 ), quickUIScale( FLEX_DROPDOWN_WIDTH - 2 ), quickUIScale( 18 ), "Zero", IDC_FLEXZERO );

		w += quickUIScale( ( FLEX_DROPDOWN_WIDTH + 4 ) + 5 );
		new mxButton( wFlex, w, h + quickUIScale( 1 ), quickUIScale( FLEX_DROPDOWN_WIDTH - 2 ), quickUIScale( 18 ), "One", IDC_FLEXONE );
	}
}
...
void ControlPanel::SetupPhysicsWindow( mxTab* pTab )
{
	...
	new mxLabel (wPhysics, quickUIScale( 5 ), quickUIScale( 33 ), quickUIScale( 30 ), quickUIScale( 18 ), "Mass");
	leMass = new mxLineEdit(wPhysics, quickUIScale( 35 ), quickUIScale( 30 ), quickUIScale( 70 ), quickUIScale( 22 ), "", IDC_PHYS_MASS);

	cPhysicsBone = new mxChoice (wPhysics, quickUIScale( 5 ), quickUIScale( 5 ), quickUIScale( 345 ), quickUIScale( 22 ), IDC_PHYS_BONE);
	cPhysicsBone->add ("None");
	cPhysicsBone->select (0);

	new mxCheckBox (wPhysics, quickUIScale( 5 ), quickUIScale( 55 ), quickUIScale( 100 ), quickUIScale( 20 ), "Highlight", IDC_PHYSICSMODEL);
	int x = 5;
	int y = 80;

	rbConstraintAxis[0] = new mxRadioButton (wPhysics, quickUIScale( x ), quickUIScale( y ), quickUIScale( 35 ), quickUIScale( 22 ), "X", IDC_PHYS_CON_AXIS_X, true);
	rbConstraintAxis[1] = new mxRadioButton (wPhysics, quickUIScale( x + 35 ), quickUIScale( y ), quickUIScale( 35 ), quickUIScale( 22 ), "Y", IDC_PHYS_CON_AXIS_Y);
	rbConstraintAxis[2] = new mxRadioButton (wPhysics, quickUIScale( x + 70 ), quickUIScale( y ), quickUIScale( 35 ), quickUIScale( 22 ), "Z", IDC_PHYS_CON_AXIS_Z);
	setPhysicsAxis( 0 );
	y += 25;

	new mxLabel (wPhysics, quickUIScale( x ), quickUIScale( y ), quickUIScale( 45 ), quickUIScale( 18 ), "Friction");
	slPhysicsFriction = new mxSlider (wPhysics, quickUIScale( x + 50 ), quickUIScale( y ), quickUIScale( 180 ), quickUIScale( 18 ), IDC_PHYS_CON_FRICTION);
	slPhysicsFriction->setRange (0, 1000.0, 1000);
	slPhysicsFriction->setValue (0);
	slPhysicsFriction->setSteps( 1, 1 );
	lPhysicsFriction = new mxLabel (wPhysics, quickUIScale( x + 230 ), quickUIScale( y ), quickUIScale( 30 ), quickUIScale( 18 ), "0");

	x = 135;
	y = 30;

	new mxLabel (wPhysics, quickUIScale( 115 ), quickUIScale( y ), quickUIScale( 30 ), quickUIScale( 18 ), "Min");
	slPhysicsConMin = new mxSlider (wPhysics, quickUIScale( x ), quickUIScale( y ), quickUIScale( 180 ), quickUIScale( 18 ), IDC_PHYS_CON_MIN);
	slPhysicsConMin->setRange (-180, 180.0, 360);
	slPhysicsConMin->setValue (-90);
	slPhysicsConMin->setSteps( 1, 1 );
	lPhysicsConMin = new mxLabel (wPhysics, quickUIScale( x + 180 ), quickUIScale( y ), quickUIScale( 30 ), quickUIScale( 18 ), "-90");
	y += 25;

	new mxLabel (wPhysics, quickUIScale( 115 ), quickUIScale( y ), quickUIScale( 30 ), quickUIScale( 18 ), "Max");
	slPhysicsConMax = new mxSlider (wPhysics, quickUIScale( x ), quickUIScale( y ), quickUIScale( 180 ), quickUIScale( 18 ), IDC_PHYS_CON_MAX);
	slPhysicsConMax->setRange (-180.0, 180.0, 360);
	slPhysicsConMax->setValue (90.0);
	slPhysicsConMax->setSteps( 1, 1 );
	lPhysicsConMax = new mxLabel (wPhysics, quickUIScale( x + 180 ), quickUIScale( y ), quickUIScale( 30 ), quickUIScale( 18 ), "90");
	y += 25;

	new mxLabel (wPhysics, quickUIScale( 115 ), quickUIScale( y ), quickUIScale( 30 ), quickUIScale( 18 ), "Test");
	slPhysicsConTest = new mxSlider (wPhysics, quickUIScale( x ), quickUIScale( y ), quickUIScale( 55 ), quickUIScale( 18 ), IDC_PHYS_CON_TEST);
	slPhysicsConTest->setRange (0, 1.0, 100);
	slPhysicsConTest->setValue (0);

	cbLinked = new mxCheckBox (wPhysics, quickUIScale( 200 ), quickUIScale( y ), quickUIScale( 50 ), quickUIScale( 20 ), "Link", IDC_PHYS_CON_LINK_LIMITS);
	mxToolTip::add (cbLinked, "Link mins/maxs to be symmetric");
	new mxButton (wPhysics, quickUIScale( 250 ), quickUIScale( y ), quickUIScale( 80 ), quickUIScale( 22 ), "Generate QC", IDC_PHYS_QCFILE);

	x += 220;
	y = 5;
	new mxLabel (wPhysics, quickUIScale( x ), quickUIScale( y ), quickUIScale( 55 ), quickUIScale( 18 ), "Mass Bias");
	new mxLabel (wPhysics, quickUIScale( x ), quickUIScale( y+25 ), quickUIScale( 55 ), quickUIScale( 18 ), "Inertia");
	new mxLabel (wPhysics, quickUIScale( x ), quickUIScale( y+50 ), quickUIScale( 55 ), quickUIScale( 18 ), "Damping");
	new mxLabel (wPhysics, quickUIScale( x ), quickUIScale( y+75 ), quickUIScale( 55 ), quickUIScale( 18 ), "Rot Damp");
	new mxLabel (wPhysics, quickUIScale( x ), quickUIScale( y+100+3 ), quickUIScale( 55 ), quickUIScale( 18 ), "Material");
	x += 55;

	slPhysicsParamMassBias = new mxSlider (wPhysics, quickUIScale( x ), quickUIScale( y ), quickUIScale( 76 ), quickUIScale( 18 ), IDC_PHYS_P_MASSBIAS );
	slPhysicsParamMassBias->setRange (0, 10.0, 100);
	slPhysicsParamMassBias->setValue (1.0);
	slPhysicsParamMassBias->setSteps( 1, 1 );
	lPhysicsParamMassBias = new mxLabel (wPhysics, quickUIScale( x+80 ), quickUIScale( y ), quickUIScale( 30 ), quickUIScale( 18 ), "1.0");
	y += 25;

	slPhysicsParamInertia = new mxSlider (wPhysics, quickUIScale( x ), quickUIScale( y ), quickUIScale( 76 ), quickUIScale( 18 ), IDC_PHYS_P_INERTIA );
	slPhysicsParamInertia->setRange (0, 10.0, 100);
	slPhysicsParamInertia->setValue (1.0);
	slPhysicsParamInertia->setSteps( 1, 1 );
	lPhysicsParamInertia = new mxLabel (wPhysics, quickUIScale( x+80 ), quickUIScale( y ), quickUIScale( 30 ), quickUIScale( 18 ), "1.0");
	y += 25;

	slPhysicsParamDamping = new mxSlider (wPhysics, quickUIScale( x ), quickUIScale( y ), quickUIScale( 76 ), quickUIScale( 18 ), IDC_PHYS_P_DAMPING );
	slPhysicsParamDamping->setRange (0, 1.0, 100);
	slPhysicsParamDamping->setValue (0.01);
	slPhysicsParamDamping->setSteps( 1, 1 );
	lPhysicsParamDamping = new mxLabel (wPhysics, quickUIScale( x+80 ), quickUIScale( y ), quickUIScale( 30 ), quickUIScale( 18 ), "0.5");
	y += 25;

	slPhysicsParamRotDamping = new mxSlider (wPhysics, quickUIScale( x ), quickUIScale( y ), quickUIScale( 76 ), quickUIScale( 18 ), IDC_PHYS_P_ROT_DAMPING );
	slPhysicsParamRotDamping->setRange (0, 10.0, 200);
	slPhysicsParamRotDamping->setValue (0.2);
	slPhysicsParamRotDamping->setSteps( 1, 1 );
	lPhysicsParamRotDamping = new mxLabel (wPhysics, quickUIScale( x+80 ), quickUIScale( y ), quickUIScale( 30 ), quickUIScale( 18 ), "0.2");
	y += 25;

	lPhysicsMaterial = new mxLabel( wPhysics, quickUIScale( x ), quickUIScale( y+3 ), quickUIScale( 110 ), quickUIScale( 18 ), "default" );
}
...
void ControlPanel::SetupIKRuleWindow( mxTab *pTab )
{
	...
	new mxLabel( wIKRule, quickUIScale( 5 ), quickUIScale( 5 ), quickUIScale( 80 ), quickUIScale( 20 ), "Chain:" );
	cIKChain = new mxChoice( wIKRule, quickUIScale( 90 ), quickUIScale( 5 ), quickUIScale( 50 ), quickUIScale( 20 ), IDC_IKRULE_CHAIN );
	cIKChain->add( "lfoot" );
	cIKChain->add( "rfoot" );
	cIKChain->add( "lhand" );
	cIKChain->add( "rhand" );
	...
	new mxLabel( wIKRule, quickUIScale( 145 ), quickUIScale( 5 ), quickUIScale( 80 ), quickUIScale( 20 ), "Type:" );
	cIKType = new mxChoice( wIKRule, quickUIScale( 230 ), quickUIScale( 5 ), quickUIScale( 80 ), quickUIScale( 20 ), IDC_IKRULE_CHOICE );
	...
	lIKTouch = new mxLabel( wIKRule, quickUIScale( 315 ), quickUIScale( 5 ), quickUIScale( 80 ), quickUIScale( 20 ), "Bone:" );
	cIKTouch = new mxChoice( wIKRule, quickUIScale( 400 ), quickUIScale( 5 ), quickUIScale( 200 ), quickUIScale( 20 ), IDC_IKRULE_TOUCH );
	PopulateBoneList( cIKTouch );
	mxToolTip::add( cIKTouch, "Select Touched Bone" );

	lIKAttachment = new mxLabel( wIKRule, quickUIScale( 315 ), quickUIScale( 5 ), quickUIScale( 80 ), quickUIScale( 20 ), "Attachment:" );
	leIKAttachment = new mxLineEdit( wIKRule, quickUIScale( 400 ), quickUIScale( 5 ), quickUIScale( 80 ), quickUIScale( 20 ), "", IDC_IKRULE_ATTACHMENT );

	cbIKRangeToggle = new mxCheckBox( wIKRule, quickUIScale( 5 ), quickUIScale( 30 ), quickUIScale( 80 ), quickUIScale( 20 ), "Range", IDC_IKRULE_RANGE_TOGGLE );
	mxToolTip::add( cbIKRangeToggle, "Toggle range option" );
	new mxButton( wIKRule,  quickUIScale( 90 ), quickUIScale( 30 ), quickUIScale( 30 ), quickUIScale( 20 ), "start", IDC_IKRULE_RANGE_START_NOW );
	leIKRangeStart = new mxLineEdit2( wIKRule, quickUIScale( 120 ), quickUIScale( 30 ), quickUIScale( 35 ), quickUIScale( 20 ), "..", IDC_IKRULE_RANGE_START );
	new mxButton( wIKRule, quickUIScale( 160 ), quickUIScale( 30 ), quickUIScale( 30 ), quickUIScale( 20 ), "peak", IDC_IKRULE_RANGE_PEAK_NOW );
	leIKRangePeak = new mxLineEdit2( wIKRule, quickUIScale( 190 ), quickUIScale( 30 ), quickUIScale( 35 ), quickUIScale( 20 ), "..", IDC_IKRULE_RANGE_PEAK );
	new mxButton( wIKRule, quickUIScale( 230 ), quickUIScale( 30 ), quickUIScale( 30 ), quickUIScale( 20 ), "tail", IDC_IKRULE_RANGE_TAIL_NOW );
	leIKRangeTail = new mxLineEdit2( wIKRule, quickUIScale( 260 ), quickUIScale( 30 ), quickUIScale( 35 ), quickUIScale( 20 ), "..", IDC_IKRULE_RANGE_TAIL );
	new mxButton( wIKRule, quickUIScale( 300 ), quickUIScale( 30 ), quickUIScale( 30 ), quickUIScale( 20 ), "end", IDC_IKRULE_RANGE_END_NOW );
	leIKRangeEnd = new mxLineEdit2( wIKRule, quickUIScale( 330 ), quickUIScale( 30 ), quickUIScale( 35 ), quickUIScale( 20 ), "..", IDC_IKRULE_RANGE_END );

	cbIKContactToggle = new mxCheckBox( wIKRule, quickUIScale( 5 ), quickUIScale( 55 ), quickUIScale( 80 ), quickUIScale( 20 ), "Contact", IDC_IKRULE_CONTACT_TOGGLE );
	mxToolTip::add( cbIKContactToggle, "Toggle contact option" );
	new mxButton( wIKRule, quickUIScale( 90 ), quickUIScale( 55 ), quickUIScale( 30 ), quickUIScale( 20 ), "frame", IDC_IKRULE_CONTACT_FRAME_NOW );
	leIKContactFrame = new mxLineEdit2( wIKRule, quickUIScale( 120 ), quickUIScale( 55 ), quickUIScale( 35 ), quickUIScale( 20 ), "", IDC_IKRULE_CONTACT_FRAME );

	new mxLabel( wIKRule, quickUIScale( 5 ), quickUIScale( 80 ), quickUIScale( 80 ), quickUIScale( 20 ), "Transform using:" );
	cIKUsing = new mxChoice( wIKRule, quickUIScale( 90 ), quickUIScale( 80 ), quickUIScale( 80 ), quickUIScale( 20 ), IDC_IKRULE_USING );
	...
	new mxLabel( wIKRule, quickUIScale( 5 ), quickUIScale( 105 ), quickUIScale( 80 ), quickUIScale( 20 ), "QC String:" );
	leIKQCString = new mxLineEdit2( wIKRule, quickUIScale( 90 ), quickUIScale( 105 ), quickUIScale( 500 ), quickUIScale( 20 ), "", IDC_IKRULE_QC_STRING );
	UpdateIKRuleWindow();
}
...
void ControlPanel::SetupEventWindow( mxTab *pTab )
{
	...
	new mxLabel( wEvents, quickUIScale( 5 ), quickUIScale( 5 ), quickUIScale( 80 ), quickUIScale( 20 ), "Sound:" );
	mxButton *bSoundFrameNow = new mxButton( wEvents,  quickUIScale( 90 ), quickUIScale( 5 ), quickUIScale( 30 ), quickUIScale( 20 ), "frame", IDC_EVENT_SOUND_FRAME_NOW );
	mxToolTip::add( bSoundFrameNow, "Set sound start at the current frame" );
	leEventSoundFrame = new mxLineEdit2( wEvents, quickUIScale( 120 ), quickUIScale( 5 ), quickUIScale( 35 ), quickUIScale( 20 ), "0", IDC_EVENT_SOUND_FRAME );
	lbEventSoundName = new mxListBox( wEvents, quickUIScale( 160 ), quickUIScale( 5 ), quickUIScale( 300 ), quickUIScale( 170 ), IDC_EVENT_SOUND_NAME );
	PopulateSoundNameList( lbEventSoundName );
	mxToolTip::add( lbEventSoundName, "Select Sound Name" );

	new mxLabel( wEvents, quickUIScale( 5 ), quickUIScale( 170 ), quickUIScale( 80 ), quickUIScale( 20 ), "QC String:" );
	leEventQCString = new mxLineEdit2( wEvents, quickUIScale( 90 ), quickUIScale( 170 ), quickUIScale( 450 ), quickUIScale( 20 ), "", IDC_EVENT_QC_STRING );
	BuildEventQCString();
}
...
ControlPanel::handleEvent (mxEvent *event)
{
	...
	{
		tab->setBounds( 0, 0, event->width, max( 0, event->height - quickUIScale( 20 ) ) );
		return 1;
	}
