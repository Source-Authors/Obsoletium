...
{
public:
	[[nodiscard]] virtual ReplayHandle_t		GetMovieHandle()  const = 0;
	[[nodiscard]] virtual ReplayHandle_t		GetReplayHandle() const = 0;
	...
	[[nodiscard]] virtual const char			*GetMovieFilename() const = 0;
	...
	[[nodiscard]] virtual bool				IsUploaded() const = 0;
	virtual void				SetUploaded( bool bUploaded ) = 0;
	virtual void				SetUploadURL( const char *pURL ) = 0;
	[[nodiscard]] virtual const char			*GetUploadURL() const = 0;
};
